...
@interface QWDToolsScrinViewController ()
...
@implementation QWDToolsScrinViewController

- (id)init
{
    return  (([[UIDevice currentDevice] resolution] == UIDeviceResolution_iPhoneRetina5))?
                        [self initWithNibName:@"QWDToolsScrinViewController4" bundle:nil] : [self initWithNibName:@"QWDToolsScrinViewController3.5" bundle:nil];
