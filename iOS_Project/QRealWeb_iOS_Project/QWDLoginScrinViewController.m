...
@interface QWDLoginScrinViewController ()

@end

@implementation QWDLoginScrinViewController
...
- (void)respondsForAuthRequest:(BOOL)isAccepted
{
    if (isAccepted) {
        ...
        QWDFastAuthViewController *fastAuthViewController = [[QWDFastAuthViewController alloc] init];
